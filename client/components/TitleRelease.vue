<template>
    <div @click="changeSize()" class="Card border-b border-leftbar flex px-5 py-2 h-full hover:bg-background" :class="this.widthVideo == '100%' ? 'flex-col':'lg:flex-row justify-between'">
