    ...
    <NuxtLink :to="`/artist/${element.artist.id}`" class="flex flex-col md:space-y-5 bg-gray-500 bg-opacity-30 text-white rounded-xl w-full md:w-56 md:text-sm">
        <div class="flex justify-between px-2 py-2">
            <div class="flex space-x-3 md:space-x-0">
                <div class="md:hidden">
                    <img loading="lazy" class="w-10 h-10 rounded-full object-cover shadowCard" :src="element.artist.image" alt="">
                </div>
            ...
            <div v-if="element.verified">
                <img loading="lazy" class="w-5 my-auto" src="~/assets/image/approval.png" alt="Verified mark">
            </div>
        </div>
        <div class="hidden md:flex justify-center">
            <img loading="lazy" class="w-16 h-16 md:w-36 md:h-36 rounded-full object-cover shadowCard" :src="element.artist.image" alt="">
        </div>
