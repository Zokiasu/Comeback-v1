      ...
      <div id="top" class="flex flex-col xl:flex-row space-y-5 xl:space-y-0 xl:space-x-10 my-5">
        ...
        <div class="flex flex-col justify-between space-y-5 xl:space-y-0">
          <div id="artist-name">
              ...
              <select v-model="release.releaseType" id="artist-type-selector" class="w-full xl:w-96 focus:outline-none p-2 bg-gray-100 border focus:border-white transition-colors duration-500">
          ...
          <div id="artist-name">
              ...
              <div id="divider" class="border-b border-red-700 border-1 my-2 mb-2 w-96"></div>
              <input v-model="release.artist" placeholder="Artist Name" class="w-full xl:w-96 focus:outline-none p-2 focus:text-white bg-gray-100 border focus:bg-gray-400 focus:border-white transition-colors duration-500" type="text">
          </div>
        </div>
        <div id="artist-name">
            <h1 class="text-white text-xl">Release Date*</h1>
            <div id="divider" class="border-b border-red-700 border-1 my-2 mb-2 w-96"></div>
            <input v-model="release.date" class="w-full xl:w-96 focus:outline-none p-2 focus:text-white bg-gray-100 border focus:bg-gray-400 focus:border-white transition-colors duration-500" type="text">
        </div>
      </div>
