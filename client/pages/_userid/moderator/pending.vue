        ...
        <section id="pending-page" class="py-5 grid grid-cols-1 lg:grid-cols-2 gap-3">
            ...
            <Modal
                ...
                <div class="relative flex flex-col justify-center m-5 p-10 bg-opacity-50 rounded overflow-hidden overflow-y-scroll text-white bg-gray-500">
                    <div>
                        <img :src="this.pendings[this.indexEdit].currentData.image" :alt="this.pendings[this.indexEdit].currentData.name" class="w-40 h-40 object-cover">
                    </div>
                    <ul class="my-2 space-y-2 py-5">
                        <li v-if="this.pendings[this.indexEdit].currentData.name || this.pendings[indexEdit].body.name" class="space-y-1">
                            <span>Name : <span>{{this.pendings[this.indexEdit].currentData.name}}</span></span>
                            <t-input v-if="this.pendings[this.indexEdit].body.name" v-model="this.pendings[this.indexEdit].body.name" placeholder="Name" name="name" type="text"></t-input>
                        </li>
                        <li v-if="this.pendings[this.indexEdit].currentData.type || this.pendings[indexEdit].body.type" id="artists-type-selector" class="space-y-1">
                            <span>Type : <span>{{this.pendings[this.indexEdit].currentData.type}}</span></span>
                            <t-select v-if="this.pendings[this.indexEdit].body.type" v-model="this.pendings[this.indexEdit].body.type" :options="[ { value: 'SOLO', text: 'Soloist' }, { value: 'GROUP', text: 'Group' }, ]" ></t-select>
                        </li>
                        <li v-if="this.pendings[this.indexEdit].currentData.description || this.pendings[indexEdit].body.description" class="space-y-1">
                            <span>Description : <span>{{this.pendings[this.indexEdit].currentData.description}}</span> </span>
                            <t-textarea v-if="this.pendings[this.indexEdit].body.description" v-model="this.pendings[this.indexEdit].body.description" placeholder="Description" name="description" type="text"></t-textarea>
                        </li>
                        <li v-if="this.pendings[this.indexEdit].currentData.website || this.pendings[indexEdit].body.website" class="space-y-1">
                            <span>Website : <span>{{this.pendings[this.indexEdit].currentData.website}}</span> </span>
                            <t-input v-if="this.pendings[this.indexEdit].body.website" v-model="this.pendings[this.indexEdit].body.website" placeholder="Website" name="website" type="text"></t-input>
                        </li>
                        <li v-if="this.pendings[this.indexEdit].currentData.members || this.pendings[indexEdit].body.members" class="space-y-1">
                            <div class="flex space-x-1"><span>Members :</span><div class="space-x-1"><span v-for="(member, index) in this.pendings[this.indexEdit].currentData.members" :key="index" class="bg-gray-500 p-1 px-2 rounded text-xs text-white">{{member.name}}</span></div></div>
                            <multiselect
                                v-if="this.pendings[this.indexEdit].body.members"
                        ...
                        <li v-if="this.pendings[this.indexEdit].currentData.groups || this.pendings[indexEdit].body.groups" class="space-y-1">
                            <div class="flex space-x-1"><span>Belong To The Groups :</span><div class="space-x-1"><span v-for="(group, index) in this.pendings[this.indexEdit].currentData.groups" :key="index" class="bg-gray-500 p-1 px-2 rounded text-xs text-white">{{group.name}}</span></div></div>
                            <multiselect
                                v-if="this.pendings[this.indexEdit].body.groups"
                        ...
                        <li v-if="this.pendings[this.indexEdit].currentData.styles || this.pendings[indexEdit].body.styles" class="space-y-1">
                            <div class="flex space-x-1"><span>Styles :</span><div class="space-x-1"><span v-for="(style, index) in this.pendings[this.indexEdit].currentData.styles" :key="index" class="bg-gray-500 p-1 px-2 rounded text-xs">{{style}}</span></div></div>
                            <multiselect
                                 v-if="this.pendings[this.indexEdit].body.styles"
                        ...
                        <li v-if="this.pendings[indexEdit].currentData.socials || this.pendings[indexEdit].body.socials" class="space-y-1">
                            <span>Social :</span>
                        ...
                        <li v-if="this.pendings[indexEdit].currentData.platforms || this.pendings[indexEdit].body.platforms" class="space-y-1">
                            <span>Platforms :</span>
    ...
    export default {
        ...
        methods: {
            ...
            editByModerator(){
                ...
                console.log(this.pendings[this.indexEdit])
            },
