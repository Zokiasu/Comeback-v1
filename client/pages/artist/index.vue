<template>
  <div>
    <div>
      <div class="my-5 mx-10 flex">
        <button class="bg-gray-400 pr-1 pl-2 rounded-none rounded-l py-1.5">
          <div class="">
        ...
        <input type="text" placeholder="Search" v-model="search" class="w-1/2 xl:w-1/3 pl-2 focus:outline-none rounded-r rounded-none bg-gray-400 text-white placeholder-white">
      </div>
    </div>
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-y-5 md:gap-y-10 mt-10 my-5 w-full justify-center">
      <ArtistCard 
