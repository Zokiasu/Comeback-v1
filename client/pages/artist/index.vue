<template>
  <div>
    <div class="m-10 mb-20 flex w-full justify-center">
      ...
      <input type="text" placeholder="Search" v-model="search" class="w-1/2 pl-2 focus:outline-none rounded-r rounded-none bg-gray-400 text-white placeholder-white">
    </div>
