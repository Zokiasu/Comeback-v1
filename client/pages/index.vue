<template>
  <div>
    ...
    <section id="description" class="w-full my-20 relative grid grid-flow-col auto-cols-col auto-rows-auto gap-2 max-w-full">
      <img class="object-cover animate__fadeIn w-full" style="min-height:15rem;" src="'https://firebasestorage.googleapis.com/v0/b/comeback-65643.appspot.com/o/images%2Flistartist.png?alt=media&token=02164587-06cf-4e06-845b-7f75261244b9'" alt="Artist List">
