<template>
    <div class="p-10">
        <div class="flex space-x-2 lg:justify-between text-white border-b border-white">
...
<script>
    export default {
        ...
        methods:{
            async followArtist() {
                this.liked = true
                await this.$axios.put(`https://comeback-api.herokuapp.com/users/${this.userData.id}`, { artists: [this.artist] }).then(response => {
