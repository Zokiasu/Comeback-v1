...
const doCreateSeeds = false;

sequelize.sync({ force: eraseDatabaseOnSync }).then(async () => {
  if (eraseDatabaseOnSync && doCreateSeeds) {
    createSeeds();
  }
  ...
  await models.Artist.create(
    {
      name: 'NCT',
      image:
        'https://altselection.com/wp-content/uploads/2020/11/nct-2020.jpg',
      type: 'GROUP',
      website: null,
      description:
        'NCT is a South Korean boy band created by the label SM Entertainment that debuted in 2016. The groups name is short for Neo Culture Technology, a term coined by Lee Soo Man, the founder of SM Entertainment. The concept of the group is to have an unlimited number of members divided into several sub-units around the world. Members are free to stay or leave the group and other members can be added at any time. The long-term goal for the agency is to have active sub-units in several countries such as China, Japan etc...',
  ...
  const membersArray = [
    {
      name: 'Kun',
      image:
        'https://static.wikia.nocookie.net/k-pop/images/9/99/Bad_Alive_-_Kun_1.jpg/revision/latest?cb=20200728123643&path-prefix=fr',
      type: 'SOLO',
      website: null,
      description:
        'Kun (쿤, kun) is a Chinese singer, and rapper, member of NCT. He was introduced as an official member of the group in 2016 during his participation in the Chinese version of "Without You". But he made his official debut in 2018. He is part of the Chinese sub-unit WayV, of which he is the leader.',
      socials: [
    ...
    },
    {
      name: 'Ten',
      image:
        'https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Ten_Lee_%EB%B3%B4%EB%8A%94_%EB%9D%BC%EB%94%94%EC%98%A4_201124_04.png/270px-Ten_Lee_%EB%B3%B4%EB%8A%94_%EB%9D%BC%EB%94%94%EC%98%A4_201124_04.png',
      type: 'SOLO',
      website: null,
      description:
    ...
    },
    {
      ...
      website: null,
      description:
        'Dong Si-cheng, better known as Winwin, is a Chinese singer and dancer based in South Korea, born on October 28, 1997. Since 2016, he has been a member of the boy band NCT and its sub-units, NCT U, NCT 127 and WayV.',
    ...
    },
    {
      name: 'Lucas',
      image:
        'https://k-gen.fr/wp-content/uploads/2019/09/superm-lucas-titre-720x426.png',
      type: 'SOLO',
      website: null,
      description:
        'Wong Yuk-hei, better known as Lucas, is a Hong Kong rapper, singer and model of Thai and Chinese descent. He is a member of the South Korean boy group NCT, its Chinese sub-unit WayV and its spinning sub-unit NCT U, as well as the supergroup SuperM',
    ...
    },
    {
      name: 'Xiao Jun',
      image:
        'https://static.wikia.nocookie.net/k-pop/images/1/16/Bad_Alive_-_Xiaojun_1.jpg/revision/latest?cb=20200728124023&path-prefix=fr',
      type: 'SOLO',
      website: null,
      description:
        'Xiaojun or Xiao Jun is a Chinese singer and member of the group NCT. He is part of the WayV subunit in which he officially debuted on January 17, 2019 with the release of the group\'s first single "The Vision".',
      socials: [
    ...
    },
    {
      name: 'Hendery',
      image:
        'https://45secondes.fr/wp-content/uploads/2020/11/Hendery-de-NCT-montre-son-cote-sexy-dans-les-photos.jpeg',
      type: 'SOLO',
      website: null,
      description:
        'Hendery is a Chinese dancer and singer from the Macau autonomous administrative region of China. He has been part of the SMROOKIES project since July 2018, and is now a member of the Chinese sub-unit of the NCT group named WayV.',
      socials: [
    ...
    },
    {
      name: 'Yang Yang',
      image:
        'https://static.wikia.nocookie.net/wayv/images/c/cb/0310_Profile_YANGYANG.png/revision/latest?cb=20210422182101',
      type: 'SOLO',
      website: null,
      description:
        'Yang-Yang or Yang Yang (양양) is a German-Chinese singer, member of the group NCT. He is part of the WayV subunit in which he officially debuted on January 17, 2019 with the release of the group\'s first single "The Vision".',
